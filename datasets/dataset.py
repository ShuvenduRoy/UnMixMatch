...
class BasicDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.transform = transform  # weak augmentation
        if self.is_ulb:
    ...
    def random_sampler_update(self, new_len):
        """
        Just updating the length of data is enough.
        """
        self.num_data = new_len
        print('#data_loader_update: current labeled examples: ', self.num_data)
